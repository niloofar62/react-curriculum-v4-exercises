...
In this week's exercises, you're going to build two components that fetch and display data from an API.
...
To complete these exercises, you will work in the following files:

- `src/exercises/week-07/FetchOnRender.jsx`: This is the component that fetches a list of posts as soon as it's rendered.
- `src/exercises/week-07/FetchOnClick.jsx`: This is the component that fetches a single post when a button inside of it is clicked.
- `src/exercises/week-07/api.js`: This is where the functions used to fetch posts will live.

**Note:** You do not need to modify `src/exercises/week-07/studentWork.jsx` — it already imports and uses the relevant components for you.
...
- In `FetchOnRender.jsx`, import the `getPosts()` function from `src/exercises/week-07/api.js`.
- When the component renders, call `getPosts()`.
  - **Note:** This function doesn't do anything yet! You need to finish the logic to make a fetch request in `src/exercises/week-07/api.js`.
...
- In `FetchOnClick.jsx`, import the `getSinglePost()` function from `src/exercises/week-07/api.js`.
